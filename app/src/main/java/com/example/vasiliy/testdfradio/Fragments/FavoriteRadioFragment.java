...
public class FavoriteRadioFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ContentAdapterForFavoriteList adapter = new ContentAdapterForFavoriteList();
    ...
    public static class ContentAdapterForFavoriteList extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ContentAdapterForFavoriteList() {
            ...
            LENGTH = radioChannels.likes.size();
            if(LENGTH != 0) {
                index = new int[LENGTH];
                for(int i = 0; i < LENGTH; ++i) {
                    index[i] = radioChannels.likes.get(i);
                }
            }
        }
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            holder.mNameDadio.setText(radioChannels.mRadioNames[index[position]]);
            holder.mLocation.setText(radioChannels.mLocations[index[position]]);
        }
